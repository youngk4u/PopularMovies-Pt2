...
public class NetworkUtils {
    ...
    /**
     * Builds the URL for trailer youtube intent.
     *
     * @return the URL to be used.
     */
    public static URL buildTrailerListJsonUrl(int movieId) {
        Uri builtUri = Uri.parse(BASE_URL).buildUpon()
    ...
    /**
     * Builds the URL for user reviews.
     *
     * @return the URL to be used.
     */
    public static URL buildReviewListJsonUrl(int movieId) {
        Uri builtUri = Uri.parse(BASE_URL).buildUpon()
                .appendPath(String.valueOf(movieId))
                .appendPath(REVIEWS)
                .appendQueryParameter(KEY_PARAM, API_KEY)
